...
public interface DAOConstants {
	...
	public String SELECT_DURATA_MEDIA_CORSO = "Select AVG(datafinecorso-datainiziocorso) as durata_media_corsi from corso";// ok
	...
	public String SELECT_PASSADMI = "Select codadmin where nome = ? and cognome = ?";// error?
